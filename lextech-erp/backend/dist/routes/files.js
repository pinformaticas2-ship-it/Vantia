...
router.get('/test-preview', requireAuth, filesController_1.testPreviewImages);
router.post('/:clientId/create-blank', requireAuth, filesController_1.createBlankDocument);
router.get('/:clientId', requireAuth, filesController_1.listFiles);
...
router.delete('/:clientId/:fileId', requireAuth, filesController_1.deleteFile);
