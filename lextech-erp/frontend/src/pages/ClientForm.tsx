...
import {
  ...
  Camera, Briefcase, Users, Calendar, Clock, AlertCircle, TrendingUp
} from "lucide-react";
      ...
      <form onSubmit={handleSubmit} className="flex-1 min-w-0 space-y-4">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <Link to="/dashboard/clientes" className="p-2 hover:bg-slate-100 rounded-lg text-slate-500">
              <ArrowLeft size={18} />
            </Link>
            <div>
              <h1 className="text-xl font-bold text-slate-900">Nuevo Cliente</h1>
              <p className="text-slate-400 text-xs">Ficha de alta · todos los campos son editables</p>
            </div>
          </div>
      ...
      <aside className="w-52 shrink-0 space-y-4">
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden sticky top-6">
          ...
          <div className="px-4 pb-3">
            <p className="text-[10px] text-slate-300 italic">Disponible tras guardar el cliente</p>
          </div>
        </div>
      </aside>
