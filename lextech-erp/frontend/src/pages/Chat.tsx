          ...
          >
            ...
            {showFilePreview && fileSrc && (
              <FilePreviewModal
                ...
                mime={msg.file_mime}
                subtitle={`${resolveDisplayName(msg.user_id, msg.user_name, isMe)} · ${new Date(msg.created_at).toLocaleDateString("es-ES", { day: "numeric", month: "short" })} · ${fmtTime(msg.created_at)}`}
