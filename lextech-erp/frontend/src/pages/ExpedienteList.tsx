...
export default function ExpedienteList() {
  ...
  if (error) return (
    <div className="space-y-4">
      ...
      <ConnectionErrorBanner error={error} onRetry={() => fetchExpedientes()} title="No se han podido cargar los expedientes" />
    </div>
  );
      ...
      {showModal && (
        <ExpedienteModal
          ...
          initial={editItem ? {
            ...
            abogado_propio:       editItem.abogado_propio       || "",
            abogado_contrario:    editItem.abogado_contrario    || "",
            procurador_contrario: editItem.procurador_contrario || "",
